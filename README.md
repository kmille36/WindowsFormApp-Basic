 ...
 **NEW: Multi RDP Manager v1.5 (ReleasePublic) - Phần mềm lưu quản lý nhiều VPS**
 + Kết nối nâng cao: tuỳ chỉnh độ phân giải RDP khi kết nối
 + Nếu RDP không có mật khẩu: sử dụng kết nối nâng cao
 + Chức năng chính: Lưu thông tin RDP vào txt, tìm kiếm RDP trong danh sách, bỏ qua cảnh báo kết nối trực tiếp vào RDP( mặc định mỗi khi kết nối), kết nối với độ phân giải custom. Nếu tool báo lỗi khi đọc txt mở file txt và sửa lại
